...
class CatRank(StrEnum):
    ...
    DENKEEPER_APPRENTICE = "denkeeper apprentice"
    GARDENER_APPRENTICE = "gardener apprentice"
    MESSENGER_APPRENTICE = "messenger apprentice"
    STORYTELLER_APPRENTICE = "storyteller apprentice"
    WARRIOR = "warrior"
    ...
    def is_any_herb_gatherer_rank(self) -> bool:
        return self in (self.MEDICINE_CAT, self.MEDICINE_APPRENTICE, self.GARDENER, self.GARDENER_APPRENTICE, self.CARETAKER, self.CARETAKER_APPRENTICE)
    ...
    def is_any_apprentice_rank(self) -> bool:
        return self in (
            ...
            self.CARETAKER_APPRENTICE,
            self.DENKEEPER_APPRENTICE,
            self.GARDENER_APPRENTICE,
            self.MESSENGER_APPRENTICE,
            self.STORYTELLER_APPRENTICE
        )

    def is_any_adult_warrior_like_rank(self) -> bool:
        return self in (self.WARRIOR, self.DEPUTY, self.LEADER, self.DENKEEPER, self.MESSENGER)
