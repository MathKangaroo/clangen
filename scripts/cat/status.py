...
class Status:
    ...
    social_lookup = {
        ...
        CatRank.CARETAKER_APPRENTICE: CatSocial.CLANCAT,
        CatRank.DENKEEPER_APPRENTICE: CatSocial.CLANCAT,
        CatRank.GARDENER_APPRENTICE: CatSocial.CLANCAT,
        CatRank.MESSENGER_APPRENTICE: CatSocial.CLANCAT,
        CatRank.STORYTELLER_APPRENTICE: CatSocial.CLANCAT,
        CatRank.WARRIOR: CatSocial.CLANCAT,
        CatRank.CARETAKER: CatSocial.CLANCAT,
        CatRank.DENKEEPER: CatSocial.CLANCAT,
        CatRank.GARDENER: CatSocial.CLANCAT,
        CatRank.MESSENGER: CatSocial.CLANCAT,
        CatRank.STORYTELLER: CatSocial.CLANCAT,
