    ...
    for i, cat in enumerate(cat_data):
        try:
            ...
            new_cat.pelt = Pelt(
                ...
                pattern=cat["pattern"],
                tortie_tint=cat["tortie_tint"] if "tortie_tint" in cat else (cat["tint"] if "tint" in cat else "none"),
                displays_2nd_tortie=cat["displays_2nd_tortie"] if "displays_2nd_tortie" in cat else False,
                tortiecolour2=cat["tortie_color_2"] if "tortie_color_2" in cat else None,
                tortiepattern2=cat["tortie_pattern_2"] if "tortie_pattern_2" in cat else None,
                pattern2=cat["pattern_2"] if "pattern_2" in cat else None,
                tortie_tint2=cat["tortie_tint_2"] if "tortie_tint_2" in cat else (cat["tint"] if "tint" in cat else "none"),
                skin=cat["skin"],
            ...
            if "skill_dict" in cat:
                ...
                if new_cat.backstory is None:
                    if "skill" == "formerly a loner":
                        backstory = choice(["loner1", "loner2", "rogue1", "rogue2", "rogue3", "rogue4", "loner3", "loner4", "loner5", "loner6", "loner7"])
