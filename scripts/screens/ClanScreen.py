...
class ClanScreen(Screens):
    ...
    def choose_cat_positions(self):
        ...
        for x in game.clan.clan_cats:
            ...
            elif Cat.all_cats[x].status.rank in [CatRank.KITTEN, CatRank.CARETAKER, CatRank.CARETAKER_APPRENTICE]:
                [
                    Cat.all_cats[x].placement,
                    base_pos,
                ] = self.choose_nonoverlapping_positions(
            ...
            elif Cat.all_cats[x].status.rank.is_any_medicine_rank() or Cat.all_cats[x].status.rank in [CatRank.GARDENER,CatRank.GARDENER_APPRENTICE]:
                [
                    Cat.all_cats[x].placement,
                    base_pos,
                ] = self.choose_nonoverlapping_positions(
            ...
            elif Cat.all_cats[x].status.rank in (CatRank.WARRIOR, CatRank.MEDIATOR, CatRank.STORYTELLER, CatRank.MESSENGER, CatRank.DENKEEPER):
                [
                    Cat.all_cats[x].placement,
                    base_pos,
                ] = self.choose_nonoverlapping_positions(
