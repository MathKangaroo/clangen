...
class ClanScreen(Screens):
    ...
    def choose_cat_positions(self):
        ...
        for x in game.clan.clan_cats:
            ...
            if Cat.all_cats[x].status in ["apprentice", "mediator apprentice", "denkeeper apprentice", "messenger apprentice", "storyteller apprentice"]:
                Cat.all_cats[x].placement = self.choose_nonoverlapping_positions(
            ...
            elif Cat.all_cats[x].status in ["medicine cat apprentice", "medicine cat", "gardener", "gardener apprentice"]:
                Cat.all_cats[x].placement = self.choose_nonoverlapping_positions(
                    first_choices, all_dens, [20, 20, 20, 400, 1, 1, 1]
                )
            elif Cat.all_cats[x].status in ["warrior", "mediator", "messenger", "denkeeper", "storyteller"]:
                Cat.all_cats[x].placement = self.choose_nonoverlapping_positions(
