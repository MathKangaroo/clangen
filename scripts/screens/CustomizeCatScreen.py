...
class CustomizeCatScreen(Screens):
    ...
    def setup_dropdowns(self):
        ...
        if self.the_cat.awakened and 'FLAMES' not in self.skins:
            magic_skin_temp = copy(Pelt.skin_sprites_magic) + copy(Pelt.skin_sprites_elemental) + ['GREENCHIMERA', 'CORALCHIMERA', 'FROSTGLOW','THIRDEYE', 'CRYSTALS', 'FOXTAIL','CLOUDS', 'BATWINGS', 'TRANSCLOUDS','SPOOKYCRYSTALS']
