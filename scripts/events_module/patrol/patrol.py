...
class Patrol:
    ...
    def add_patrol_cats(self, patrol_cats: List[Cat], clan: Clan) -> None:
        ...
        for cat in patrol_cats:
            ...
            if cat.status.rank.is_any_herb_gatherer_rank():
    ...
    def get_possible_patrols(
        ...
        patrol_type = (
            "med"
            if [CatRank.MEDICINE_CAT, CatRank.MEDICINE_APPRENTICE, CatRank.CARETAKER, CatRank.CARETAKER_APPRENTICE, CatRank.GARDENER, CatRank.GARDENER_APPRENTICE]
